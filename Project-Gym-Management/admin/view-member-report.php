     ...
     <div class="widget-content">
              ...
              <div class="span4">
                <table class="">
                  <tbody>
                    ...
                    <tr>
                      <td>Immeuble Plaza, 2 B Avenue de Marbotte, 21000 Dijon</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: +33 3 79 66 00 17</td>
                    </tr>
                    <tr>
                      <td >Email: dij-staff@holbertonschool.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
                ...
                <div class="pull-right">
                  ...
                  <img src="../img/report/Basic-Fit_logo.png" width="124px;" alt=""><p class="text-center">Note:AutoGenerated</p> </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Sébastien Daqiq</a> </div>
</div>
